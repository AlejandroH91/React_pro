    ...
    return (
        <footer className="bg-success text-white fixed-bottom">
            <div className="container text-start">
                <div className="row">
                    <div className="col-12 col-md-4 text-start fs-2">
                        <p></p>
                    </div>
                     <div className="col-12 col-md-4 text-center fs-2">
                        <p>Copy Right © 2026</p>
                    </div>
                    <div className="col-12 col-md-4 text-center">
                        <Link className="text-white text-decoration-none" to="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="50" fillRule="currentColor" className="bi bi-wordpress" viewBox="0 0 16 16">
                        ...
                        <Link className="text-white text-decoration-none" to="#">
                            <svg xmlns="http://www.w3.org/2000/svg"  width="40" height="50" fillRule="currentColor" className="bi bi-ubuntu" viewBox="0 0 16 16">
